...
const Song = () => {
    ...
    // Get the current location, which contains the selected song's name and artist
    const location = useLocation();
    const song_name = location.state.song_name
    const artist_name = location.state.song_artist

    // Fetch recommendations when the component mounts or when the song name or artist name changes
    useEffect(() => {
